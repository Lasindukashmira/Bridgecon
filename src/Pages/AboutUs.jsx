      ...
      <section className="aboutHero">
        <div className="aLeft">
          ...
          <p className="aboutLead" ref={leadRef}>
            ...
            operational efficiency, and enable sustainable growth.
            <br />
            With a balance of expert guidance and unwavering support, we
            transform complex technology into meaningful business outcomes -
            helping you move from vision to reality, faster and smarter.
          </p>
        </div>
      ...
      <section className="whoweare aboutStory">
        ...
        <div className="wright">
          ...
          <p className="wpara storyText">
            ...
            insight to craft solutions that are secure, scalable, and
            human-centered.
          </p>
          <div className="pointcontainer">
            <div className="pointrow2">
              ...
              <p>
                Outcome-driven delivery with rapid iteration for maximum
                agility.
              </p>
            </div>
            <div className="pointrow2">
              ...
              <p>
                Security-first mindset integrated into every layer of our
                solutions.
              </p>
            </div>
            <div className="pointrow2">
              ...
              <p>
                Collaborative approach backed by transparent, open
                communication.
              </p>
            </div>
          </div>
      ...
      <section className="missionVision">
        ...
        <div className="mvGrid">
          <div className="mvCard">
            ...
            <p className="mvText">
              To empower businesses with reliable, modern technology that drives
              measurable impact, delivers long-term value, and creates a
              competitive edge.
            </p>
          </div>
          <div className="mvCard">
          ...
          <div className="mvCard">
            ...
            <p className="mvText">
              We commit to partnership, integrity, and relentless improvement at
